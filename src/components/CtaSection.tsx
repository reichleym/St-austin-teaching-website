...
export default function CtaSection({ className }: { className?: string }) {
    return (
        <>
            <section className={`pb-25 ${className || ''}`}>
                    ...
                    <div className="bg-[#1E73BE] text-white rounded-lg grid md:grid-cols-10 gap-10 items-center">
                        <div className="md:col-span-6">
                            <div className="md:max-w-[80%] py-6 px-6 mx-auto">
                                <h2 className="font-semibold text-4xl mb-[10px">Find your learning path</h2>
                                <p className="text-[15px] mb-6 md:w-[80%]">Answer a few questions to get personalized recommendations on what learning path is best for you.</p>
