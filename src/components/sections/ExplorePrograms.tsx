            ...
            <section className={`pt-25 ${className}`} {...rest}>
                <div className="container">
                    <div className="bg-[#1E73BE] p-10 rounded-lg text-white grid grid-cols-1 md:grid-cols-4 items-center">
                        ...
                        <form action={action} method="GET" className="flex items-end gap-5 col-span-1 md:col-span-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 flex-1">
                                <div className="col-span-1">
                                    ...
                                    <div className="inline-block relative w-full">
                                        <select
                                            ...
                                            className="block appearance-none w-full border border-[#FFFFFFBF] hover:border-white px-4 py-2 pr-8 rounded leading-tight focus:outline-none font-medium"
                                        >
                                ...
                                <div className="col-span-1">
                                    <label htmlFor="field-of-study" className="block text-xs font-medium mb-2">Field of study</label>
                                    <div className="inline-block relative w-full">
                                        <select
                                            id="field-of-study"
                                            name="fieldOfStudy"
