        ...
        <section className="py-16 md:py-24">
            <div className="container max-w-3xl">
                <div className="rounded-[14px] border border-[#33333340] bg-white p-8 shadow-sm md:p-12">
                    <p className="text-sm font-semibold uppercase tracking-[0.12em] text-[#1E73BE]">Portal Dashboard</p>
                    ...
                    <p className="mt-3 text-base text-[#666666]">
                        This is your protected dashboard entry point. You can now connect courses, assignments, and
