...
export async function generateMetadata() {
  ...
  return {
    ...
    description:
      data.banner?.description ?? "Support and discounts for public employees.",
  };
}
...
export default async function GovernmentEmployeesPage() {
  ...
  const bannerContent = {
    title:
      data.banner?.title ??
      translate(
        "governmentEmployees.bannerTitle",
        translations,
    ...
    description:
      ...
      translate(
        "governmentEmployees.bannerDescription",
        translations,
        fallbackTranslations,
      ),
  ...
  const employeeGroups: EmployeeGroup[] = (
    ...
    {
      title: translate(
        "governmentEmployees.groups.civilService.title",
        translations,
        fallbackTranslations,
      ),
      summary: translate(
        "governmentEmployees.groups.civilService.summary",
        translations,
        fallbackTranslations,
      ),
      support: [
        translate(
          "governmentEmployees.groups.civilService.support1",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.civilService.support2",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.civilService.support3",
          translations,
          fallbackTranslations,
        ),
      ],
    ...
    {
      title: translate(
        "governmentEmployees.groups.veterans.title",
        translations,
        fallbackTranslations,
      ),
      summary: translate(
        "governmentEmployees.groups.veterans.summary",
        translations,
        fallbackTranslations,
      ),
      support: [
        translate(
          "governmentEmployees.groups.veterans.support1",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.veterans.support2",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.veterans.support3",
          translations,
          fallbackTranslations,
        ),
      ],
    ...
    {
      title: translate(
        "governmentEmployees.groups.publicSafety.title",
        translations,
        fallbackTranslations,
      ),
      summary: translate(
        "governmentEmployees.groups.publicSafety.summary",
        translations,
        fallbackTranslations,
      ),
      support: [
        translate(
          "governmentEmployees.groups.publicSafety.support1",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.publicSafety.support2",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.publicSafety.support3",
          translations,
          fallbackTranslations,
        ),
      ],
    ...
    {
      title: translate(
        "governmentEmployees.groups.publicHealth.title",
        translations,
        fallbackTranslations,
      ),
      summary: translate(
        "governmentEmployees.groups.publicHealth.summary",
        translations,
        fallbackTranslations,
      ),
      support: [
        translate(
          "governmentEmployees.groups.publicHealth.support1",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.publicHealth.support2",
          translations,
          fallbackTranslations,
        ),
        translate(
          "governmentEmployees.groups.publicHealth.support3",
          translations,
          fallbackTranslations,
        ),
      ],
  ...
  const initialBenefit = {
    ...
    governmentVerificationStatus:
      "not_submitted" as GovernmentVerificationStatus,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <aside className="lg:col-span-1 rounded-lg border border-[#1E73BE40] bg-[#1E73BE0D] p-6">
              <p className="text-sm font-semibold text-[#1E73BE] mb-2">
                {data.quickLinks?.subtitle ??
                  translate(
                    "governmentEmployees.quickLinksSubtitle",
                    translations,
                    fallbackTranslations,
                  )}
              </p>

              <h3 className="text-[28px] font-bold leading-tight mb-5">
                {data.quickLinks?.title ??
                  translate(
                    "governmentEmployees.quickLinksTitle",
                    translations,
                    fallbackTranslations,
                  )}
              </h3>
              <ul className="space-y-3">
                {data?.quickLinks?.links?.map((item, index) => (
              ...
              <div className="mt-8">
                <p className="font-semibold mb-2">
                  {translate(
                    "governmentEmployees.contactSupport",
                    translations,
                    fallbackTranslations,
                  )}
                </p>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-6 rounded-lg border border-[#33333333] bg-white p-6">
                <h3 className="text-[28px] font-bold mb-2">
                  {translate(
                    "governmentEmployees.howDiscountWorksTitle",
                    translations,
                    fallbackTranslations,
                  )}
                </h3>
                <ul className="space-y-2 text-[17px] text-[#333333CC]">
                  <li className="flex gap-2">
                    ...
                    <span>
                      {data.howItWorks?.steps
                        ? data.howItWorks.steps[0]
                        : translate(
                            "governmentEmployees.howDiscountWorksStep1",
                            translations,
                            fallbackTranslations,
                          )}
                    </span>
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>
                      {data.howItWorks?.steps ? (
                        data.howItWorks.steps[1]
                      ) : (
                        <>
                          {translate(
                            "governmentEmployees.howDiscountWorksStep2Part1",
                            translations,
                            fallbackTranslations,
                          )}{" "}
                          <strong>
                            {initialBenefit.governmentDiscountPercent}% off
                          </strong>{" "}
                          {translate(
                            "governmentEmployees.howDiscountWorksStep2Part2",
                            translations,
                            fallbackTranslations,
                          )}
                        </>
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>
                      {data.howItWorks?.steps
                        ? data.howItWorks.steps[2]
                        : translate(
                            "governmentEmployees.howDiscountWorksStep3",
                            translations,
                            fallbackTranslations,
                          )}
                    </span>
              ...
              <div className="space-y-5">
                {employeeGroups.map((group) => (
                  <article
                    key={group.title}
                    className="rounded-lg border border-[#33333333] p-6"
                  >
                    <h3 className="text-[26px] font-bold mb-2">
                      {group.title}
                    </h3>
                ...
                <div className="flex gap-3 flex-wrap">
                  ...
                  >
                    {data.cta?.buttons?.[0]?.text ??
                      translate(
                        "governmentEmployees.cta.startApplication",
                        translations,
                        fallbackTranslations,
                      ) ??
                      "Start Application"}
                  ...
                  >
                    {data.cta?.buttons?.[1]?.text ??
                      translate(
                        "governmentEmployees.cta.viewPrograms",
                        translations,
                        fallbackTranslations,
                      ) ??
                      "View Programs"}
