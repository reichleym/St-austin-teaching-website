                ...
                <div className="container">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {teamMembers.map((member) => (
                            <div key={member.name} className="card rounded-lg border border-[#F5F5F5] bg-[#F5F5F5] overflow-hidden">
                                <img src={member.image} alt={member.name} className="w-[322px] h-[322px] object-cover" />
                                <div className="p-5 bg-[#F5F5F5]">
                                    <h4 className="font-semibold mb-[5px] text-[22px]">{member.name}</h4>
                                    <h5 className="text-lg font-medium mb-[10px] text-[#1E73BE]">{member.role}</h5>
