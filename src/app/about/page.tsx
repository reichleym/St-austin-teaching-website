...
export async function generateMetadata() {
  ...
  return {
    title:
      aboutData.banner?.title ?? "About St. Austin's International University",
    description:
      aboutData.banner?.description ??
      "Learn more about St. Austin's International University.",
  };
}
...
export default async function AboutPage() {
  ...
  const [aboutData] = await Promise.all([
    ...
    getStudentExperienceContent(lang),
  ]);
  ...
  const bannerContent = {
    title:
      ...
      translate("about.title", translations, fallbackTranslations),
    description:
      aboutData.banner?.description ??
  ...
  const historyContent = {
    title:
      ...
      translate("about.history", translations, fallbackTranslations),
    description:
      aboutData.history?.description ??
      translate("about.historyDesc", translations, fallbackTranslations),
      ...
      <section className="md:py-25 py-15">
        <div className="container">
          ...
          <IconCard
            ...
            classNameCard="border border-[#33333340] p-[30px]"
          />
        </div>
      </section>
